...
const MINI_QUESTS: MiniQuest[] = [
  ...
  {
    id: 4,
    title: "🎯 Meme-Meister Challenge",
    description: "Beweise dein ultimatives Meme-Wissen in einer Serie von kniffligen Fragen über die Krypto-Geschichte.",
    reward: "👑 Meme-Meister Titel + Spezial-NFT",
    difficulty: "hard",
    estimatedTime: "15-20 Min",
    category: "knowledge",
    requirements: "JÄGER NFT",
    completed: false,
    progress: 0
  },
  {
    id: 5,
    title: "🗺️ Geheime Location entdecken",
    description: "Nutze GPS-Koordinaten um eine versteckte Location in der realen Welt zu finden. Nur für mutige Explorer!",
    reward: "📍 Explorer Badge + Rare Item",
    difficulty: "medium",
    estimatedTime: "Variabel",
    category: "exploration",
    requirements: "GPS aktiviert",
    completed: false,
    progress: 0
  }
];
